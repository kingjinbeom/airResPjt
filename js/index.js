...
const addEvent = () => {
    ...
    sighUpMenuBtn.addEventListener('click', function () {
        console.log('sighUpMenuBtn CLICKED!!');
    ...
    sighInMeuBtnn.addEventListener('click', function () {
    ...
    // 예약 메뉴
    let resMenuBtn = document.querySelector('div.menu_wrap a.write');
    ...
    //예약 리스트
    let listBtn = document.querySelector('div.write_wrap button');
